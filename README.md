...
The numerical results are exported in the **VTK** format, allowing post-processing and visualization of flow fields—such as velocity and pressure—using **ParaView**.
